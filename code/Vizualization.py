...
def pyod_vis(method, outliers_fraction = 0.1):
    ...
    X_train, Y_train = generate_data(n_train = 300, train_only = True, n_features = 2, random_state = 43)
    ...
    if method == "ABOD":
        ...
        clf = LOF(contamination = outlier_fraction)
        ...
        clf_name = 'Clustering-Based Local Outlier Factor'
        clf = CBLOF(contamination = outlier_fraction)
